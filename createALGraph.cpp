#include"headfile.h"    //创建无向邻接表

int creatALGraph(ALGraph &G){
	int m,n,i,j,k,w;
	char v1, v2;
	...
	for (k = 0;k < G.arcnum;++k) {
		...
		newNode1->adjvex = i;newNode1->info = (int*)malloc(sizeof(int));*(newNode1->info) = w;
		newNode1->nextarc = G.vertices[j].firstarc;newNode1->vex=v1;
